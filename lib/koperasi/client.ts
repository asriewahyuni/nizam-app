/**
 * Client-side helper untuk koperasi API gateway.
...
export async function koperasiApi(action: string, ...params: any[]): Promise<any> {
...
export const daftarkanShahibulMaal = (orgId: string, anggota_id: string) => koperasiApi('daftarkanShahibulMaal', orgId, anggota_id)
...
export const konfirmasiBagiHasil      = (bagiHasilId: string) => koperasiApi('konfirmasiBagiHasil', bagiHasilId)
export const setujuiDistribusi        = (bagiHasilId: string, proyekId: string) => koperasiApi('setujuiDistribusi', bagiHasilId, proyekId)
