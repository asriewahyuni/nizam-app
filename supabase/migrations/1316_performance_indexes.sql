...
CREATE INDEX  IF NOT EXISTS idx_org_module_instances_org_status
...
-- ── 5. inventory_stocks ───────────────────────────────────────
CREATE INDEX  IF NOT EXISTS idx_inventory_stocks_org_id
  ON public.inventory_stocks (org_id);

-- ── 6. branches — covering index ─────────────────────────────
-- Drop lama, buat baru dengan INCLUDE
DROP INDEX  IF EXISTS idx_branches_org_active;
...
CREATE INDEX  IF NOT EXISTS idx_employees_user_id_org_id
