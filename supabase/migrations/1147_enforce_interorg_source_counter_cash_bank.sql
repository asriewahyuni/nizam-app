-- ============================================================
-- MIGRATION 1147: Enforce Inter-Org Source Counter Account
-- ============================================================
-- Tujuan:
--   Transfer modal antar entitas harus memakai akun lawan sumber
--   berupa akun kas/bank anak/cabang (kelompok 11xx), bukan akun
--   investasi seperti 12xx.
--
-- Dampak:
--   Berlaku otomatis untuk anak perusahaan/cabang baru yang nanti
--   menambahkan/mengajukan rekening kas/bank baru.
-- ============================================================
