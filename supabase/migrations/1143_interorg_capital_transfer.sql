-- ============================================================
-- MIGRATION 1143: Inter-Organization Capital Transfer RPC
-- ============================================================
-- Tujuan:
--   Parent/Holding dapat melakukan transfer modal dari rekening bank
--   parent ke rekening bank child/cabang dalam satu call atomik.
--   Sistem akan mencatat:
--     1) transaksi OUT di org sumber (parent)
--     2) transaksi IN  di org tujuan (child/cabang)
-- ============================================================
...
BEGIN
  ...
  -- Hanya Parent/Holding yang boleh memulai transfer modal lintas entitas
