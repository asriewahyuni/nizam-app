                        ...
                        schedules.map(sc => (
                          <div key={sc.id} className="bg-white rounded-[32px] p-6 border border-slate-100 shadow-sm hover:shadow-xl transition-all group">
                             <div className="flex justify-between items-center mb-4">
                                <span className="text-[10px] font-semibold text-blue-600 uppercase tracking-wide bg-blue-50 px-3 py-1 rounded-full">{sc.status}</span>
                   ...
                   <div className="bg-white rounded-[32px] border border-slate-100 shadow-sm overflow-hidden">
                      <table className="w-full text-left">
                         <thead className="bg-slate-50 border-b border-slate-100">
                            <tr>
                               <th className="px-8 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Nama Rute (Trayek)</th>
                               <th className="px-6 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Asal (Origin)</th>
                               <th className="px-6 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Tujuan (Dest)</th>
                               <th className="px-6 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide text-right">Harga Dasar</th>
                ...
                <div className="space-y-6">
                   ...
                   <div className="bg-white rounded-[32px] border border-slate-100 shadow-sm overflow-hidden">
                      <table className="w-full text-left">
                         <thead className="bg-slate-50 border-b border-slate-100">
                            <tr>
                               <th className="px-8 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Penumpang</th>
                               <th className="px-6 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Rute & Bus</th>
                               <th className="px-6 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Kursi</th>
                               <th className="px-6 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide text-right">Harga</th>
                               <th className="px-8 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Status</th>
                            </tr>
                         </thead>
                         <tbody className="divide-y divide-slate-50">
                        ...
                        crew.map((c: any) => (
                          <div key={c.id} className="bg-white rounded-[32px] p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all group relative overflow-hidden">
                             ...
                             <div className="relative">
                                <span className={`px-3 py-1 text-[9px] font-semibold rounded-lg uppercase tracking-wide border ${
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-wide">NIK: {c.nik}</p>
                ...
                <div className="space-y-6">
                   ...
                   <div className="bg-white rounded-[32px] border border-slate-100 shadow-sm overflow-hidden">
                      <table className="w-full text-left">
                         <thead className="bg-slate-50 border-b border-slate-100">
                            <tr>
                               <th className="px-8 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Kru (Pegawai)</th>
                               <th className="px-6 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Waktu In/Out</th>
                               <th className="px-6 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide text-center">Lokasi (GPS)</th>
                               <th className="px-6 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">QR Scan</th>
                               <th className="px-8 py-5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide text-right">Status</th>
                            </tr>
                         </thead>
                         <tbody className="divide-y divide-slate-50">
                    ...
                    return (
                      <motion.div key={asset.id} variants={item} className="bg-white rounded-[32px] p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:border-blue-100 group transition-all">
                         <div className="flex justify-between items-start mb-6">
                            <div className="w-14 h-14 bg-slate-50 text-slate-400 rounded-xl flex items-center justify-center group-hover:bg-blue-50 group-hover:text-blue-600 transition-colors">
                               <Icon size={28} />
                            </div>
                         ...
                         <div className="space-y-4">
                            <div>
                               ...
                               <p className="text-xs font-bold text-slate-400 tracking-wide mt-1">{asset.plate_number}</p>
                            </div>
          ...
          <motion.div key="bookings" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-6">
             <div className="bg-white rounded-[32px] border border-slate-100 shadow-sm overflow-hidden overflow-x-auto">
                <table className="w-full text-left min-w-[800px]">
                   <thead className="bg-slate-50 border-b border-slate-100">
                      <tr>
                         <th className="px-8 py-6 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Pelanggan & Unit</th>
                         <th className="px-6 py-6 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Periode Sewa</th>
                         <th className="px-6 py-6 text-[10px] font-semibold text-slate-400 uppercase tracking-wide text-right">Durasi</th>
                         <th className="px-6 py-6 text-[10px] font-semibold text-slate-400 uppercase tracking-wide text-right">Nominal</th>
                         <th className="px-6 py-6 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Status</th>
                         <th className="px-8 py-6 text-[10px] font-semibold text-slate-400 uppercase tracking-wide text-right">Aksi</th>
                      </tr>
                   </thead>
                   <tbody className="divide-y divide-slate-50">
                      {bookings.length === 0 ? (
           ...
           <motion.div key="labs" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-8">
              ...
              <div className="bg-white rounded-[32px] border border-slate-100 shadow-sm overflow-hidden overflow-x-auto">
                 <table className="w-full text-left min-w-[800px]">
                    <thead className="bg-slate-50 border-b border-slate-100">
                       <tr>
                          <th className="px-8 py-6 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">No. Medis & Unit</th>
                          <th className="px-6 py-6 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Jenis & Deskripsi</th>
                          <th className="px-6 py-6 text-[10px] font-semibold text-slate-400 uppercase tracking-wide text-right">Biaya (Rp)</th>
                          <th className="px-6 py-6 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Posisi KM</th>
                          <th className="px-6 py-6 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Teknisi / Bengkel</th>
                          <th className="px-8 py-6 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Lampiran</th>
                       </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-50">
      ...
      <AnimatePresence>
        {showAssetModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
             ...
             <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-lg bg-white rounded-[32px] shadow-md overflow-hidden p-8">
                ...
                <form onSubmit={handleAddAsset} className="space-y-6">
                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Model Kendaraan</label>
                         <input name="model" required placeholder="Cth: Toyota Avanza" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Merek (Brand)</label>
                         <input name="brand" placeholder="Cth: Toyota" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                   </div>
                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Nomor Plat</label>
                         <input name="plate_number" required placeholder="B 1234 ABC" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold uppercase" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Jenis Kendaraan</label>
                         <select name="type" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold">
                   ...
                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Harga Sewa / Hari</label>
                         <input name="daily_rate" type="number" required placeholder="350000" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Odometer Saat Ini (KM)</label>
                         <input name="odometer" type="number" placeholder="0" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                   </div>
                   <button type="submit" disabled={loading} className="w-full py-5 bg-blue-600 text-white font-semibold rounded-xl shadow-xl shadow-blue-100 mt-4">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
             ...
             <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-lg bg-white rounded-[32px] shadow-md overflow-hidden p-8">
                ...
                <form onSubmit={handleAddBooking} className="space-y-6">
                   <div className="space-y-1.5">
                      <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Pilih Pelanggan (Contact)</label>
                      <select name="contact_id" required className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-emerald-500 font-bold">
                         <option value="">-- Nama Customer --</option>
                         {contacts.map(c => <option key={c.id} value={c.id}>{c.name}</option>)}
                      </select>
                   </div>
                   <div className="space-y-1.5">
                      <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Pilih Kendaraan Tersedia</label>
                      <select name="asset_id" required className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-emerald-500 font-bold">
                   ...
                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         ...
                         <input name="start_date" type="datetime-local" required className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-emerald-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Tgl Selesai</label>
                         <input name="end_date" type="datetime-local" required className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-emerald-500 font-bold" />
                      </div>
                   </div>
                   <div className="space-y-1.5">
                      <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Total Biaya (Akomodasi)</label>
                      <input name="total_amount" type="number" required placeholder="0" className="w-full px-5 py-4 bg-slate-50 border border-emerald-100 rounded-xl outline-none focus:border-emerald-500 font-semibold text-2xl text-slate-900" />
                   </div>
                   <button type="submit" disabled={loading} className="w-full py-5 bg-emerald-600 text-white font-semibold rounded-xl shadow-xl shadow-emerald-50 mt-4">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
             ...
             <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-lg bg-white rounded-[32px] shadow-md overflow-hidden p-8">
                ...
                <form onSubmit={handleCreateRoute} className="space-y-5">
                   <div className="space-y-1.5">
                      <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Nama Trayek (Rute)</label>
                      <input name="name" required placeholder="Cth: Jakarta - Surabaya (Eksekutif)" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                   </div>
                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Kota Asal</label>
                         <input name="origin" required placeholder="Cth: Jakarta" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Kota Tujuan</label>
                         <input name="destination" required placeholder="Cth: Surabaya" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                   </div>
                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Jarak (KM)</label>
                         <input name="distance_km" type="number" placeholder="0" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Harga Tiket Dasar (Rp)</label>
                         <input name="base_price" type="number" required placeholder="250000" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                   </div>
                   <button type="submit" disabled={loading} className="w-full py-5 bg-blue-600 text-white font-semibold rounded-xl shadow-xl shadow-blue-50 mt-4">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
             ...
             <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-lg bg-white rounded-[32px] shadow-md overflow-hidden p-8">
                ...
                <form onSubmit={handleCreateSchedule} className="space-y-5">
                    <div className="space-y-1.5">
                       <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Pilih Rute/Trayek</label>
                       <select name="route_id" required className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-indigo-500 font-bold">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                       <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Pilih Bus Armada</label>
                         <select name="asset_id" required className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-indigo-500 font-bold">
                            <option value="">-- Armada --</option>
                            {assets.filter(a => a.type === 'BUS').map(a => <option key={a.id} value={a.id}>{a.plate_number} - {a.model}</option>)}
                         </select>
                       </div>
                       <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Waktu Keberangkatan</label>
                         <input name="departure_time" type="datetime-local" required className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-indigo-500 font-bold" />
                       </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                       <div className="space-y-1.5">
                          <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Tugaskan Sopir</label>
                          <select name="driver_id" required className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-indigo-500 font-bold">
                       ...
                       <div className="space-y-1.5">
                          <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Tugaskan Kernet</label>
                          <select name="helper_id" className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-indigo-500 font-bold">
                   ...
                   <button type="submit" disabled={loading} className="w-full py-5 bg-indigo-600 text-white font-semibold rounded-xl shadow-xl shadow-indigo-50 mt-4">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
             ...
             <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-lg bg-white rounded-[32px] shadow-md overflow-hidden p-8">
                ...
                <form onSubmit={handleBookTicket} className="space-y-5">
                   <div className="space-y-1.5">
                      <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Pilih Penumpang (Customer)</label>
                      <select name="passenger_id" required className="w-full px-5 py-4 bg-white border border-slate-200 rounded-xl outline-none focus:border-emerald-500 font-bold">
                   ...
                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">No. Kursi</label>
                         <input name="seat_number" required placeholder="Cth: 1A" className="w-full px-5 py-3 bg-white border border-slate-200 rounded-xl outline-none focus:border-emerald-500 font-semibold text-center text-emerald-600" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Harga Final (Rp)</label>
                         <input name="price" type="number" required defaultValue={selectedSchedule.route?.base_price || 0} className="w-full px-5 py-3 bg-white border border-slate-200 rounded-xl outline-none focus:border-emerald-500 font-semibold" />
                      </div>
                   </div>
                   <button type="submit" disabled={loading} className="w-full py-5 bg-emerald-600 text-white font-semibold rounded-xl shadow-xl shadow-emerald-50 mt-4">
        ...
        {showMedicalModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
             ...
             <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-lg bg-white rounded-[32px] shadow-md overflow-hidden p-8 flex flex-col max-h-[90vh]">
                <div className="flex items-center justify-between mb-8">
                   <h3 className="text-xl font-semibold text-slate-900 flex items-center gap-3">
                ...
                <form onSubmit={handleAddMedical} className="space-y-5 overflow-y-auto pr-2 custom-scrollbar">
                   <div className="space-y-1.5">
                      <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Pilih Unit Bus / Kendaraan</label>
                      <select name="asset_id" required className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-amber-500 font-bold">
                   ...
                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Tanggal Servis</label>
                         <input name="service_date" type="date" required defaultValue={new Date().toISOString().split('T')[0]} className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-amber-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Tipe Maintenance</label>
                         <select name="maintenance_type" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-amber-500 font-bold">
                   ...
                   <div className="space-y-1.5">
                      <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Deskripsi & Keluhan</label>
                      <textarea name="description" required placeholder="Jelaskan apa yang diperbaiki/diganti..." className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-amber-500 font-medium min-h-[80px]" />
                   </div>

                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Odometer Saat Servis</label>
                         <input name="odometer_at" type="number" required placeholder="0" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-amber-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Biaya Servis (Rp)</label>
                         <input name="cost" type="number" required placeholder="0" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-amber-500 font-semibold text-rose-500" />
                      </div>
                   </div>

                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Nama Teknisi</label>
                         <input name="technician_name" placeholder="Nama Mekanik" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-amber-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Bengkel (Vendor)</label>
                         <input name="vendor_name" placeholder="Nama Bengkel" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-amber-500 font-bold" />
                      </div>
                   </div>

                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Servis Berikutnya (Tgl)</label>
                         <input name="next_service_date" type="date" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-amber-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">URL Nota / Kuitansi</label>
                         <input name="attachment_url" placeholder="https://..." className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-amber-500 font-bold text-blue-500 text-xs" />
                      </div>
                   </div>

                   <button type="submit" disabled={loading} className="w-full py-5 bg-amber-500 text-white font-semibold rounded-xl shadow-xl shadow-amber-50 mt-4 flex items-center justify-center gap-3">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
             ...
             <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-lg bg-white rounded-[32px] shadow-md overflow-hidden p-8">
                ...
                <form onSubmit={handleAddCrew} className="space-y-5">
                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Nama Depan</label>
                         <input name="first_name" required placeholder="Cth: Ahmad" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Nama Belakang</label>
                         <input name="last_name" placeholder="Cth: Subarjo" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                   </div>
                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">NIK (KTP)</label>
                         <input name="nik" required placeholder="16 Digit" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Jabatan Kru</label>
                         <select name="job_title" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold">
                   ...
                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Nomor SIM</label>
                         <input name="license_number" required placeholder="B1/B2/Umum" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Masa Berlaku SIM</label>
                         <input name="license_expiry" type="date" required className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                   </div>
                   <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Nomor WA</label>
                         <input name="phone" placeholder="08..." className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold" />
                      </div>
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wide ml-1">Gol. Darah</label>
                         <select name="blood_type" className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold">
                            <option value="">-</option>
        ...
        {showScanModal && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
             ...
             <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-md bg-white rounded-xl shadow-md overflow-hidden p-8">
                <div className="flex items-center justify-between mb-8">
                   <div className="space-y-1">
                ...
                <div className="space-y-6">
                   {!selectedCrewForAttendance ? (
                     <div className="space-y-4">
                        <label className="text-xs font-semibold text-slate-500 uppercase tracking-wide ml-1">Identitas Kru (Pilih Nama Anda)</label>
                        <select 
                           value={selectedCrewForAttendance} 
                           onChange={(e) => setSelectedCrewForAttendance(e.target.value)}
                           className="w-full px-6 py-5 bg-slate-50 border-2 border-slate-100 rounded-xl outline-none focus:border-blue-500 font-bold text-lg"
                        >
                     ...
                     <div className="space-y-6">
                        <div className="relative aspect-square bg-black rounded-[32px] overflow-hidden border-4 border-slate-100 shadow-inner">
                           ...
                           <div className="absolute inset-0 border-[40px] border-black/20 pointer-events-none flex items-center justify-center">
                              <div className="w-48 h-48 border-2 border-dashed border-white/50 rounded-xl animate-pulse" />
                           </div>
                           {loading && (
                             <div className="absolute inset-0 bg-white/80 backdrop-blur-sm flex flex-col items-center justify-center text-center p-8">
                                ...
                                <p className="font-semibold text-slate-900 uppercase text-xs tracking-wide">Memproses Presensi & GPS...</p>
                             </div>
                           )}
                        </div>
