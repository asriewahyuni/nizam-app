    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-sm font-black uppercase tracking-[0.16em] text-slate-600">Card Support Ticket Baru</h2>
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-2 text-xs font-black uppercase tracking-[0.14em] text-slate-700 hover:bg-slate-100"
          >
        ...
        {isCreateCardOpen ? (
          ...
          <div className="mt-5 rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-4 py-5 text-sm font-semibold text-slate-500">
            Card support ticket baru sedang ditutup. Klik tombol <span className="font-black text-slate-700">Buka Card</span> untuk menampilkan form.
          </div>
        )}
      </section>

      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
        <h2 className="text-sm font-black uppercase tracking-[0.16em] text-slate-600">Riwayat Support Ticket</h2>
