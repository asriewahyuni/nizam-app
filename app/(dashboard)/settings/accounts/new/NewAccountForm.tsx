...
/**
 * NewAccountForm.tsx
 * Client component — form untuk menambah rekening CoA baru.
 * Hanya dirender jika server page sudah memvalidasi akses (Parent/Holding).
 */
...
import { createAccount } from '@/modules/accounting/actions/coa.actions'
...
export default function NewAccountForm({ orgId, existingAccounts }: Props) {
    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button type="button"
            onClick={() => router.back()}
            className="p-2.5 rounded-xl bg-white border border-slate-200 text-slate-500 hover:text-slate-900 hover:border-slate-300 transition shadow-sm"
          >
            <ArrowLeft size={20} />
          </button>
          <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <motion.div
            ...
            className="bg-white rounded-xl border border-slate-100 shadow-xl shadow-slate-200/50 overflow-hidden"
          >
            <form onSubmit={handleSubmit} className="p-8 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-5 py-3.5 rounded-xl bg-slate-50 border border-slate-200 text-sm font-semibold outline-none focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-50 transition-all font-mono"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-5 py-3.5 rounded-xl bg-slate-50 border border-slate-200 text-sm font-semibold outline-none focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-50 transition-all"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-2 pt-4">
                <div className="flex items-center gap-2 pb-2 border-b border-slate-50">
                  ...
                  <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wide">Keterangan Opsional</h3>
                </div>
                <textarea
              ...
              <AnimatePresence>
                {(error || success) && (
                  <motion.div
                    ...
                    className={`p-4 rounded-xl flex items-center gap-3 overflow-hidden ${error ? 'bg-rose-50 text-rose-600 border border-rose-100' : 'bg-emerald-50 text-emerald-600 border border-emerald-100'}`}
                  >
              ...
              <div className="pt-6">
                <button
                  ...
                  className="w-full py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 shadow-xl shadow-blue-200 transition disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {loading ? (
        ...
        <div className="space-y-6">
          <div className="bg-slate-900 rounded-xl p-8 text-white relative overflow-hidden">
            ...
            <div className="space-y-4 text-xs leading-relaxed text-slate-300">
              <p>
                <strong className="text-white">Normal Balance Debit:</strong> Biasanya digunakan untuk kelompok{' '}
                <span className="text-blue-400">Aset</span> dan <span className="text-blue-400">Beban</span>.
              </p>
              <p>
                <strong className="text-white">Normal Balance Kredit:</strong> Biasanya digunakan untuk kelompok{' '}
                <span className="text-blue-400">Liabilitas</span>, <span className="text-blue-400">Ekuitas</span>,
                {' '}dan <span className="text-blue-400">Pendapatan</span>.
              </p>
          ...
          <div className="bg-white border border-slate-100 rounded-xl p-6 shadow-sm">
            ...
            <ul className="space-y-3">
              {[
                ...
                'Akun sistem tidak bisa dihapus.',
