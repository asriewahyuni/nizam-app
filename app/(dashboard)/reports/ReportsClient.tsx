        ...
        <div className="flex items-center min-w-0" style={{ paddingLeft: `${row.level * 18}px` }}>
          ...
          <div className="min-w-0 flex items-center gap-2">
            ...
            {row.isSystemComputed && (
              <span className="shrink-0 rounded-full bg-amber-50 px-2 py-1 text-[9px] font-semibold uppercase tracking-wide text-amber-700 border border-amber-100">
                Otomatis
              </span>
            )}
          </div>
    ...
    <div className="flex flex-col gap-8 pb-20">
      ...
      <div className="flex flex-col gap-4 rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex flex-wrap items-center gap-2">
          <span className="text-[10px] font-semibold uppercase tracking-wide text-slate-500">Status Struktur</span>
          <span className={`inline-flex items-center rounded-full px-3 py-1 text-[11px] font-semibold uppercase tracking-wider ${isParentOrg ? 'bg-emerald-100 text-emerald-700' : 'bg-orange-100 text-orange-700'}`}>
            {isParentOrg ? 'Induk (Holding)' : 'Entitas Anak'}
          </span>
          {isConsolidated && (
            <span className="inline-flex items-center rounded-full bg-indigo-100 px-3 py-1 text-[11px] font-semibold uppercase tracking-wider text-indigo-700">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <button
            ...
            className={`flex items-center justify-center gap-2 px-6 py-3 text-xs font-bold rounded-xl border transition-all ${
              isConsolidated
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button 
            ...
            className="p-3 bg-white border border-slate-200 text-slate-400 hover:text-blue-600 hover:border-blue-200 rounded-xl shadow-sm transition-all"
          >
            <Printer size={18} />
          </button>
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-3 text-xs font-semibold rounded-xl border transition-all bg-[#003366] text-white border-[#003366] hover:bg-[#002244] shadow-md shadow-[#003366]/20 disabled:opacity-60 disabled:cursor-not-allowed"
          >
          ...
          <button 
            ...
            className={`flex items-center gap-2 px-6 py-3 text-xs font-bold rounded-xl border transition-all ${showEmptyAccounts ? 'bg-slate-900 text-white border-slate-900' : 'bg-white text-slate-600 border-slate-200 hover:bg-slate-50'}`}
          >
            <Filter size={14} />
          ...
          >
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
              <div className="px-8 py-6 bg-slate-50/50 border-b border-slate-100 flex justify-between items-center">
                ...
                <div className="text-xs font-bold text-slate-400 uppercase tracking-wide">Periode: Current Month</div>
              </div>
