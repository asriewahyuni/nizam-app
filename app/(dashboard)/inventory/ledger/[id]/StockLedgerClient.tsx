  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10 pb-20">
      ...
      <div className="flex flex-col gap-6">
        <Link 
          href="/inventory" 
          className="flex items-center gap-2 text-xs font-black text-slate-400 uppercase tracking-widest hover:text-slate-900 transition-colors w-fit group"
        >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-4">
             <div className="bg-white px-6 py-4 rounded-3xl border border-slate-100 shadow-sm flex items-center gap-4">
                ...
                <div>
                   <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Total Masuk</p>
                   <p className="text-xl font-black text-slate-900 leading-none">{totalIn} {product?.unit}</p>
                </div>
             </div>
             <div className="bg-white px-6 py-4 rounded-3xl border border-slate-100 shadow-sm flex items-center gap-4">
                ...
                <div>
                   <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Total Keluar</p>
                   <p className="text-xl font-black text-slate-900 leading-none">{totalOut} {product?.unit}</p>
                </div>
             </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
         <div className="bg-slate-900 text-white rounded-[40px] p-8 relative overflow-hidden shadow-2xl shadow-indigo-500/10 md:col-span-1">
            <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/20 rounded-full blur-3xl -mr-10 -mt-10" />
            <div className="relative z-10">
               <p className="text-[10px] font-black uppercase text-blue-400 tracking-widest mb-2">Stok Akhir</p>
         ...
         <div className="bg-white rounded-[40px] p-8 border border-slate-100 shadow-sm md:col-span-3 flex items-center justify-around">
            <div className="text-center space-y-2">
               <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Transaksi Terakhir</p>
            ...
            <div className="text-center space-y-2">
               <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Aset Persediaan</p>
               <div className="flex items-center gap-2 text-slate-900 font-black justify-center">
            ...
            <div className="w-px h-12 bg-slate-100" />
            <div className="text-center space-y-2">
               <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Total Pergerakan</p>
               <div className="flex items-center gap-2 text-slate-900 font-black justify-center">
                    ...
                    <tr>
                      <td colSpan={7} className="px-10 py-20 text-center">
                         <div className="flex flex-col items-center gap-3 opacity-20">
                            <Package size={48} />
                            <p className="text-sm font-black uppercase tracking-widest">Belum ada pergerakan stok.</p>
                         </div>
                      </td>
                    </tr>
                  ) : (
                    ledgerData.map((m: any, idx: number) => (
                      <tr key={idx} className="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="px-6 py-6">
                           <div className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest w-fit mb-1.5 border
