...
export default async function POSOnboardingPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 py-4">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-rose-600 to-pink-700 p-8 text-white shadow-2xl">
        ...
        <div className="relative">
          ...
          <div className="text-[10px] font-black uppercase tracking-[0.2em] text-rose-200 mb-2">Add-on Baru</div>
