      ...
      <div className="fixed inset-0 z-[100] bg-slate-50 flex flex-col h-screen overflow-hidden">
         ...
         <div className="h-16 bg-[#003366] text-white flex items-center justify-between px-4 md:px-6 shadow-md shrink-0 z-50 w-full relative">
            <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  ...
                  <div className="text-[8px] md:text-[10px] font-bold text-white/70 tracking-tight flex items-center gap-1 mt-0.5">
            ...
            <div className="flex items-center gap-2 md:gap-4">
               ...
               <button
                  ...
                  className="px-3 py-2 bg-emerald-500 hover:bg-emerald-400 text-white rounded-lg md:rounded-xl text-[10px] md:text-xs font-semibold tracking-tight transition-colors shadow-sm cursor-pointer block disabled:opacity-50 disabled:cursor-not-allowed"
               >
            ...
            <div className="shrink-0 border-b border-slate-200 bg-white/95 backdrop-blur-sm">
               <div className="px-4 md:px-6 py-3 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                  <div className="flex flex-wrap items-center gap-2">
                     <div className={`px-3 py-2 rounded-2xl border text-[10px] md:text-xs font-semibold tracking-tight flex items-center gap-2 ${
                        activeShiftSession
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                     {shiftState.schemaReady && (
                        <button
                           ...
                           className="px-4 py-2.5 rounded-2xl border border-slate-200 bg-white text-[10px] md:text-xs font-semibold tracking-tight text-slate-600 hover:border-slate-300 hover:text-slate-900 transition-all shadow-sm flex items-center gap-2"
                        >
                     ...
                     {!activeShiftSession && shiftState.schemaReady && (
                        <button
                           ...
                           className="px-4 py-2.5 rounded-2xl bg-slate-900 text-white text-[10px] md:text-xs font-semibold tracking-tight hover:bg-black transition-all shadow-sm"
                        >
                           Buka Shift
                        </button>
                     )}
                     {activeShiftSession && (
                        <button
                           ...
                           className="px-4 py-2.5 rounded-2xl bg-rose-600 text-white text-[10px] md:text-xs font-semibold tracking-tight hover:bg-rose-700 transition-all shadow-sm"
                        >
                           Tutup Shift
                        </button>
                     )}
                     {!activeShiftSession && shiftState.enableSettlement && shiftState.schemaReady && latestClosedShift && hasAnySettlementBalance && (
                        <button
                           ...
                           className="px-4 py-2.5 rounded-2xl bg-blue-600 text-white text-[10px] md:text-xs font-semibold tracking-tight hover:bg-blue-700 transition-all shadow-sm"
                        >
                           Settlement
                        </button>
                     )}
                     ...
                     <div className="rounded-xl border border-slate-200 bg-slate-50/80 overflow-hidden">
                           ...
                           <div className="flex flex-wrap items-center gap-2">
                              ...
                              {!historyBusy && (
                                 <button
                                    ...
                                    className="px-3 py-2 rounded-2xl border border-slate-200 bg-white text-[10px] md:text-xs font-semibold tracking-tight text-slate-600 hover:text-slate-900 hover:border-slate-300"
                                 >
                                    Refresh
                                 </button>
                              )}
                        ...
                        <div className="max-h-[360px] overflow-y-auto px-4 md:px-5 py-4 space-y-4">
                           ...
                           {shiftHistory.days.map((day) => (
                              <div key={day.dateKey} className="rounded-xl border border-slate-200 bg-white overflow-hidden shadow-sm">
                                 <div className="px-4 md:px-5 py-4 border-b border-slate-100 bg-slate-50/70 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                                    ...
                                    <div className={`px-3 py-2 rounded-2xl border text-[10px] md:text-xs font-semibold tracking-tight ${
                                          ...
                                          <div key={session.id} className="rounded-xl border border-slate-200 bg-slate-50/70 p-4 space-y-4">
                                             <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                                                <div>
                                                   <div className="flex flex-wrap items-center gap-2">
                                                      ...
                                                      <div className={`px-2.5 py-1 rounded-full text-[10px] font-semibold tracking-tight ${
                                                ...
                                                <div className="text-left md:text-right">
                                                   <div className="text-[10px] font-semibold tracking-tight text-slate-400">Sales Bruto</div>
                                             ...
                                             <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
                                                ...
                                                <div className={`rounded-2xl border p-3 ${
                                                   ...
                                                   <div className="text-[10px] font-semibold tracking-tight text-slate-400">Selisih</div>
                                             ...
                                             {(session.openingNotes || session.closingNotes) && (
                                                <div className="rounded-2xl border border-slate-200 bg-white p-4 space-y-2">
                                                   <div className="text-[10px] font-semibold tracking-tight text-slate-400">Catatan Shift</div>
                                             ...
                                             <div className="rounded-2xl border border-slate-200 bg-white p-4 space-y-3">
                                                <div className="flex flex-col gap-1 md:flex-row md:items-center md:justify-between">
                                                   <div className="text-[10px] font-semibold tracking-tight text-slate-400">Log Settlement</div>
                        ...
                        {shiftHistory.hasMore && shiftHistory.nextBeforeDateKey && (
                           <div className="px-4 md:px-5 py-4 border-t border-slate-200 bg-white/90 flex justify-center">
                              <button
                                 ...
                                 className="px-4 py-2.5 rounded-2xl border border-slate-200 bg-white text-[10px] md:text-xs font-semibold tracking-tight text-slate-600 hover:text-slate-900 hover:border-slate-300 disabled:opacity-50"
                              >
          ...
          `}>
               ...
               <div className="ml-auto w-[85%] sm:w-[450px] md:w-[400px] lg:w-[450px] bg-white border-l border-slate-200 shadow-2xl flex flex-col relative animate-in slide-in-from-right duration-300">
                  ...
                  <div className="md:hidden p-5 flex items-center justify-between bg-[#003366] text-white">
                     <h2 className="font-semibold tracking-tight text-sm">Pesanan Saya</h2>
                  ...
                  <div className="p-4 md:p-5 border-b border-slate-100 bg-slate-50">
                     <div className="flex justify-between items-center mb-3">
                        <label className="text-[10px] font-semibold tracking-tight text-slate-500 block">Database Pelanggan</label>
                        <button 
                  ...
                  <div className="flex-1 overflow-y-auto w-full p-3 space-y-2 bg-white">
                     ...
                     {cart.length === 0 && (
                        <div className="h-full flex flex-col items-center justify-center text-slate-400 opacity-60 py-12">
                           ...
                           <span className="text-[10px] font-semibold tracking-tight">Kosong</span>
                        </div>
                     )}
                  </div>
                  ...
                  <div className="bg-slate-900 text-white shadow-[0_-10px_40px_rgba(0,0,0,0.1)] md:rounded-t-[32px] overflow-hidden">
                     <div className="p-4 md:p-6 pb-2 border-b border-white/10 flex flex-col gap-2">
                        <div className="flex justify-between items-center text-[10px]">
                           <span className="font-semibold tracking-tight text-slate-400">Subtotal</span>
                        ...
                        <div className="flex justify-between items-center text-[10px] text-emerald-400">
                           <span className="font-semibold tracking-tight">Diskon Manual</span>
                           <input
                        ...
                        <div className="flex justify-between items-center text-[10px] text-rose-400">
                           <span className="font-semibold tracking-tight text-rose-400">Pajak</span>
                           <select
                        ...
                        {!appliedPromo && (
                           <div className="flex gap-2 mt-1">
                              ...
                              <button onClick={() => void handleApplyPromo()} className="h-8 px-3 bg-blue-600 hover:bg-blue-500 rounded-lg text-white font-semibold text-[10px] tracking-tight uppercase transition-colors">CEK</button>
                           </div>
                        )}
                     </div>
                     ...
                     <div className="p-4 md:p-6 pt-3">
                        <div className="flex justify-between items-center mb-4">
                           <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-tight">Grand Total</div>
                        ...
                        {shouldEnforceShift && !activeShiftSession?.id && (
                           <div className="mb-4 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-[10px] font-semibold tracking-tight text-amber-700">
                        ...
                        <button
                           ...
                           className="w-full h-14 bg-blue-600 hover:bg-blue-500 disabled:bg-slate-800 disabled:text-slate-600 text-white rounded-xl md:rounded-2xl font-semibold text-xs md:text-base tracking-tight uppercase transition-colors flex items-center justify-center gap-3 shadow-lg"
                        >
         ...
         <div className={`md:hidden fixed bottom-6 left-4 right-4 z-40 ${isMobileCartOpen || showPayment ? 'hidden' : 'block'}`}>
            <button
               ...
               className="w-full h-16 bg-[#003366] text-white rounded-xl shadow-2xl flex items-center justify-between px-6 border border-white/10 relative overflow-hidden group"
            >
               ...
               <div className="flex items-center gap-3 relative z-10">
                  ...
                  <div className="text-left">
                     <div className="text-[10px] font-semibold text-white/50 uppercase tracking-tight leading-none mb-1">Items in Cart</div>
                     <div className="text-xs font-black uppercase tracking-tighter">Lihat Detail Pesanan</div>
                  </div>
               </div>
               <div className="text-right relative z-10">
                  <div className="text-[9px] font-semibold text-emerald-400 uppercase tracking-tight mb-0.5 opacity-70 italic">Total Tagihan</div>
            ...
            {showOpenShiftModal && (
               <div className="fixed inset-0 z-[180] flex items-start md:items-center justify-center overflow-y-auto p-4 md:p-6 bg-slate-900/75 backdrop-blur-sm">
                  <motion.div
                     ...
                     className="my-auto flex max-h-[calc(100vh-2rem)] w-full max-w-2xl flex-col overflow-hidden rounded-xl bg-white shadow-2xl md:max-h-[90vh] md:rounded-xl"
                  >
                     <div className="px-5 md:px-6 py-4 border-b border-slate-100 bg-slate-50 flex items-center justify-between">
                        <div>
                           ...
                           <p className="text-[11px] font-semibold tracking-tight text-slate-400 mt-1">Unit {activeBranchName || 'Aktif'}</p>
                        </div>
                     ...
                     <div className="flex-1 overflow-y-auto p-5 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Login NIK Kasir</label>
                           <input
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Sandi Kasir</label>
                           <input
                              type="password"
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Kode Register</label>
                           <input
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Modal Awal Kas</label>
                           <input
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Akun Kas Laci</label>
                           <select
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Akun Sumber Modal Awal</label>
                           <select
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Akun Transfer</label>
                           <select
                        ...
                        <div className="space-y-2 md:col-span-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Akun QRIS / EDC</label>
                           <select
                        ...
                        <div className="space-y-2 md:col-span-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Catatan Pembuka</label>
                           <textarea
                  ...
                  >
                     <div className="px-6 md:px-8 py-5 border-b border-slate-100 bg-rose-50/70 flex items-center justify-between">
                        <div>
                           ...
                           <p className="text-[11px] font-semibold tracking-tight text-slate-400 mt-1">{activeShiftSession.registerCode}</p>
                     ...
                     <div className="p-6 md:p-8 space-y-5">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                           <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                              <div className="text-[10px] font-semibold tracking-tight text-slate-400 mb-1">Modal Awal</div>
                              <div className="text-sm font-black text-slate-800">{formatRupiah(activeShiftSession.openingCash)}</div>
                           </div>
                           <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                              <div className="text-[10px] font-semibold tracking-tight text-slate-400 mb-1">Sales Tunai</div>
                              <div className="text-sm font-black text-slate-800">{formatRupiah(activeShiftSession.totals.byMethod.CASH)}</div>
                           </div>
                           <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                              <div className="text-[10px] font-semibold tracking-tight text-slate-400 mb-1">Kembalian</div>
                              <div className="text-sm font-black text-slate-800">{formatRupiah(activeShiftSession.totals.totalChange)}</div>
                           </div>
                           <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                              <div className="text-[10px] font-semibold tracking-tight text-emerald-600 mb-1">Expected</div>
                              <div className="text-sm font-black text-emerald-700">{formatRupiah(activeShiftSession.expectedCash)}</div>
                           </div>
                           <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                              <div className="text-[10px] font-semibold tracking-tight text-slate-400 mb-1">Durasi</div>
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Kas Fisik Saat Tutup Shift</label>
                           <input
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Catatan Penutup</label>
                           <textarea
                  ...
                  >
                     <div className="px-6 md:px-8 py-5 border-b border-slate-100 bg-blue-50/70 flex items-center justify-between">
                        <div>
                           ...
                           <p className="text-[11px] font-semibold tracking-tight text-slate-400 mt-1">{latestClosedShift.registerCode}</p>
                     ...
                     <div className="p-6 md:p-8 space-y-5">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                           {(['CASH', 'QRIS', 'TRANSFER'] as PosShiftMethod[]).map((method) => (
                              <button
                                 ...
                                 className={`p-3 rounded-2xl border-2 font-semibold text-[11px] uppercase tracking-tight transition-all ${
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                           <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                              <div className="text-[10px] font-semibold tracking-tight text-slate-400 mb-1">Akun Sumber</div>
                           ...
                           <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                              <div className="text-[10px] font-semibold tracking-tight text-emerald-600 mb-1">Sisa Settlement</div>
                              <div className="text-sm font-black text-emerald-700">{formatRupiah(settlementRemaining)}</div>
                           </div>
                        </div>

                        <div className="space-y-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Akun Tujuan</label>
                           <select
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Nominal Settlement</label>
                           <input
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                           <div className="space-y-2">
                              <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Login NIK Otorisasi</label>
                              <input
                           ...
                           <div className="space-y-2">
                              <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Sandi Otorisasi</label>
                              <input
                                 type="password"
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Catatan Settlement</label>
                           <textarea
            ...
            {showPayment && (
               <div className="fixed inset-0 z-[200] flex items-center justify-center md:p-6 bg-slate-900/80 backdrop-blur-md">
                  <motion.div
                     ...
                     className="relative w-full h-full md:h-auto md:max-w-4xl bg-white md:rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden"
                  >
                     {/* Summary Side */}
                     <div className="w-full md:w-[45%] bg-[#003366] text-white p-6 md:p-10 flex flex-col justify-between relative">
                        <div className="relative z-10">
                           <div className="flex justify-between items-center md:block mb-8 md:mb-0">
                              <div className="w-12 h-12 md:w-16 md:h-16 bg-white/10 rounded-lg md:rounded-3xl flex items-center justify-center border border-white/20 backdrop-blur-sm">
                           ...
                           <div className="space-y-3 md:space-y-4">
                              ...
                              <div className="flex justify-between items-center pt-4 md:pt-6">
                                 <span className="font-semibold text-white uppercase tracking-tight text-[10px] md:text-xs">TOTAL AKHIR</span>
                           ...
                           <div className="h-full flex flex-col items-center justify-center text-center py-10 md:py-0">
                              ...
                              <div className="bg-white border border-slate-200 rounded-3xl p-6 w-full mb-8 shadow-sm max-w-sm">
                                 <div className="flex justify-between items-center mb-4 text-[10px] md:text-xs">
                                    <span className="uppercase font-semibold text-slate-400 tracking-tight">Total Bayar</span>
                                 ...
                                 <div className="flex justify-between items-center pt-4 border-t border-dashed border-slate-200">
                                    <span className="text-[10px] md:text-xs uppercase font-semibold text-blue-500 tracking-tight italic">KEMBALIAN</span>
                              ...
                              <div className="bg-white border border-slate-200 rounded-3xl p-5 w-full mb-5 shadow-sm max-w-sm text-left">
                                 <label className="block text-[10px] font-semibold tracking-tight text-slate-400 mb-2">
                              ...
                              <div className="grid grid-cols-2 gap-3 w-full max-w-sm mb-3">
                                 <button onClick={() => window.print()} className="py-4 bg-white border border-slate-200 text-slate-600 font-semibold tracking-tight uppercase text-[10px] rounded-2xl hover:bg-slate-100 shadow-sm w-full">Struk Fisik</button>
                                 <button onClick={sendWaReceipt} className="py-4 bg-emerald-50 border border-emerald-200 text-emerald-600 font-semibold tracking-tight uppercase text-[10px] rounded-2xl hover:bg-emerald-100 shadow-sm w-full flex items-center justify-center gap-1.5"><MessageCircle size={14} /> WhatsApp</button>
                              </div>
                              <button onClick={resetPOS} className="w-full max-w-sm py-5 bg-blue-600 text-white font-semibold tracking-tight uppercase text-xs rounded-2xl hover:bg-blue-500 shadow-lg shadow-blue-500/20 mt-2">PESANAN BERIKUTNYA</button>
                           </div>
                        ) : (
                           <div className="flex flex-col h-full">
                              <div className="hidden md:flex justify-between items-center mb-4">
                                 <h3 className="text-[10px] font-semibold tracking-tight text-slate-400">Penyelesaian Transaksi</h3>
                                 <button onClick={() => setShowPayment(false)} className="text-rose-500 hover:bg-rose-50 p-1.5 rounded-lg"><X size={18} /></button>
                              </div>

                              <label className="text-[10px] font-semibold tracking-tight text-slate-400 mb-2">Metode Pembayaran</label>
                              <div className="grid grid-cols-3 gap-2 md:gap-3 mb-8">
                                 <button onClick={() => setPaymentMethod('CASH')} className={`p-3 md:p-4 rounded-xl md:rounded-2xl border-2 flex flex-col items-center gap-2 md:gap-3 transition-all ${paymentMethod === 'CASH' ? 'border-[#003366] bg-blue-50 text-[#003366]' : 'border-slate-100 bg-white text-slate-300'}`}>
                                    ...
                                    <span className="text-[8px] md:text-[10px] font-semibold tracking-tight">Tunai</span>
                                 </button>
                                 <button onClick={() => setPaymentMethod('QRIS')} className={`p-3 md:p-4 rounded-xl md:rounded-2xl border-2 flex flex-col items-center gap-2 md:gap-3 transition-all ${paymentMethod === 'QRIS' ? 'border-[#003366] bg-blue-50 text-[#003366]' : 'border-slate-100 bg-white text-slate-300'}`}>
                                    ...
                                    <span className="text-[8px] md:text-[10px] font-semibold tracking-tight">QRIS / EDC</span>
                                 </button>
                                 <button onClick={() => setPaymentMethod('TRANSFER')} className={`p-3 md:p-4 rounded-xl md:rounded-2xl border-2 flex flex-col items-center gap-2 md:gap-3 transition-all ${paymentMethod === 'TRANSFER' ? 'border-[#003366] bg-blue-50 text-[#003366]' : 'border-slate-100 bg-white text-slate-300'}`}>
                                    ...
                                    <span className="text-[8px] md:text-[10px] font-semibold tracking-tight">Transfer</span>
                                 </button>
                              </div>
                              ...
                              <div className="space-y-6 flex-1">
                                 ...
                                 <div className="space-y-2">
                                    <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Gudang Pengeluaran</label>
                                    <select
                                 ...
                                 <div className="space-y-1.5 opacity-80 pointer-events-none mb-6">
                                    <label className="text-[10px] font-semibold tracking-tight text-emerald-700 ml-1 flex items-center gap-1.5">
                                 ...
                                 {paymentMethod === 'CASH' && (
                                    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2">
                                       <div className="space-y-2">
                                          <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">Nominal Tunai Diterima</label>
                                          <div className="relative">
                                       ...
                                       {changeDue > 0 && amountTendered && (
                                          <div className="p-3 md:p-4 mt-2 rounded-xl bg-orange-50 border border-orange-100 flex items-center justify-between animate-in fade-in">
                                             <span className="text-[10px] md:text-xs font-semibold tracking-tight text-orange-600/70">Kembalian</span>
                                 ...
                                 <div className="space-y-2">
                                    <label className="text-[10px] font-semibold tracking-tight text-slate-400 ml-1">
                                       Custom Pesan WhatsApp
                                    </label>
                                    <textarea
                              ...
                              <div className="pt-6 mt-auto">
                                 <button disabled={loading || !activeBranchId || (requiresWarehouseSelection && !selectedWarehouseId)} onClick={handlePay} className="w-full h-16 md:h-[72px] bg-[#003366] hover:bg-[#002244] text-white flex flex-col items-center justify-center gap-1 rounded-2xl md:rounded-xl shadow-xl transition-all font-semibold text-[11px] md:text-xs tracking-tight disabled:opacity-50">
                                    {loading ? (
