    ...
    <div className="space-y-6">
      ...
      <section className="overflow-hidden rounded-[32px] border border-emerald-200 bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.18),_transparent_42%),linear-gradient(135deg,#f0fdf4_0%,#ffffff_46%,#ecfeff_100%)] p-6 shadow-sm">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              href="#buat-pelatihan"
              className="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-200 transition hover:bg-black"
            >
              Buat Pelatihan
            ...
            {accessContext.canReviewAssessments ? (
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-300 hover:text-slate-900"
              >
                Panel Penilai
              </Link>
            ) : null}
      ...
      <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <div id="buat-pelatihan" className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Create Training</div>
            ...
            <form action={createCompetencyTraining} className="mt-5 grid gap-4">
              <div className="grid gap-4 md:grid-cols-2">
                <label className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                  <div className="font-semibold text-slate-900">Judul Pelatihan</div>
                  <input
                    name="title"
                    required
                ...
                <label className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                  <div className="font-semibold text-slate-900">Skill / Kategori</div>
                  <input
                    name="skillCategory"
                ...
                <label className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                  <div className="font-semibold text-slate-900">Target Role</div>
                  <input
                    name="targetRole"
                ...
                <label className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                  <div className="font-semibold text-slate-900">Fasilitator</div>
                  <input
                ...
                <label className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                  <div className="font-semibold text-slate-900">Jenis Pelatihan</div>
                  <select
                    name="trainingType"
                ...
                <label className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                  <div className="font-semibold text-slate-900">Mode Delivery</div>
                  <select
                    name="deliveryMode"
                ...
                <label className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                  <div className="font-semibold text-slate-900">Scope Pelatihan</div>
                  <select
                    name="scopeType"
                    defaultValue="ORG"
                    className="mt-3 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-400"
                ...
                <label className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                  <div className="font-semibold text-slate-900">Tanggal Mulai</div>
                  <input
                    type="date"
                    name="startDate"
                    className="mt-3 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-400"
                ...
                <label className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                  <div className="font-semibold text-slate-900">Tanggal Selesai</div>
                  <input
                    type="date"
                    name="endDate"
                    className="mt-3 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-emerald-400"
                ...
                <label className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                  <div className="font-semibold text-slate-900">Durasi (jam)</div>
                  <input
                    type="number"
                    min="0"
                    step="0.5"
              ...
              <label className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                <div className="font-semibold text-slate-900">Tujuan Pelatihan</div>
                <textarea
                  name="objective"
                  rows={4}
              ...
              <label className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
                <div className="font-semibold text-slate-900">Catatan Tambahan</div>
                <textarea
                  name="notes"
                  rows={4}
          ...
          <div className="mt-5 space-y-4">
            <div className="rounded-xl border border-emerald-200 bg-emerald-50/70 p-5">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-[18px] border border-emerald-200 bg-white p-4">
                  <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Karyawan</div>
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
              <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Catatan Operasional</div>
      ...
      <section id="daftar-pelatihan" className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex items-center justify-between gap-4">
          <div>
            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Training Catalog</div>
              ...
              <div key={training.id} className="rounded-[24px] border border-slate-200 bg-slate-50 p-5">
                <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                  <div className="max-w-3xl">
                    ...
                    <div className="mt-4 flex flex-wrap gap-4 text-xs font-bold uppercase tracking-wide text-slate-500">
                  ...
                  <div className="w-full max-w-sm space-y-3">
                    <Link
                      ...
                      className="inline-flex w-full items-center justify-between rounded-[20px] border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-semibold text-emerald-800 transition hover:border-emerald-300 hover:bg-emerald-100"
                    >
                  ...
                  {accessContext.canManage ? (
                    <>
                      <form action={updateCompetencyTrainingStatus} className="rounded-[20px] border border-slate-200 bg-white p-4">
                        ...
                        <button
                          type="submit"
                          className="mt-3 inline-flex items-center gap-2 rounded-xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white transition hover:bg-black"
                        >
                          Simpan Status
                        </button>
                      </form>
                      ...
                      <form action={deleteCompetencyTraining} className="rounded-[20px] border border-rose-200 bg-rose-50 p-4">
                        <input type="hidden" name="trainingId" value={training.id} />
                        <div className="text-[11px] font-semibold uppercase tracking-wide text-rose-700">Hapus Program</div>
                        <p className="mt-2 text-sm leading-6 text-rose-800">
                          Gunakan ini jika pelatihan dibuat salah atau tidak jadi dipakai.
                        </p>
                        <button
                          type="submit"
                          className="mt-3 inline-flex items-center gap-2 rounded-xl bg-rose-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-rose-700"
                        >
                          Hapus Pelatihan
                        </button>
                      </form>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <h3 className="mt-4 text-base font-semibold text-slate-900">Bukan SaaS-only</h3>
        ...
        <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <h3 className="mt-4 text-base font-semibold text-slate-900">Fleksibel untuk Skill Business</h3>
          <p className="mt-2 text-sm leading-6 text-slate-600">
