        ...
        {PIPELINE_STAGES.map(stage => {
           ...
           return (
             <div 
               ...
               className={`flex flex-col h-full rounded-xl border-2 ${stage.col} overflow-hidden transition-colors border-dashed`}
             >
                <div className="p-5 border-b border-black/5 flex justify-between items-center bg-white/50 backdrop-blur-sm">
                   <div className="flex items-center gap-2">
                     <Icon size={18} className="text-slate-500" />
                     <h3 className="text-xs font-semibold tracking-tight text-slate-700">{stage.title}</h3>
                   </div>
                ...
                <div className="px-5 py-3 border-b border-black/5 bg-white/30 flex items-center justify-between text-slate-600">
                   <span className="text-[10px] uppercase font-semibold tracking-tight">Total Value:</span>
                    ...
                    return (
                      ...
                      >
                        <div className="flex justify-between items-start mb-1.5">
                          <div className="text-[9px] font-semibold text-slate-400 uppercase tracking-tight group-hover:text-blue-500 transition-colors">
