      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="border-b border-slate-100 bg-slate-50/50 px-6 py-5">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-black text-slate-900">Harga Modul Inti (Core)</h2>
          </div>
        ...
        <div className="p-6">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {coreModules.map((mod) => (
              <div key={mod.key} className="flex flex-col gap-2 p-4 rounded-2xl border border-slate-100 bg-slate-50/50">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="border-b border-slate-100 bg-slate-50/50 px-6 py-5">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-black text-slate-900">Harga Modul Operasional</h2>
          </div>
          <p className="mt-1 text-xs text-slate-500">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="border-b border-slate-100 bg-slate-50/50 px-6 py-5">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-black text-slate-900">Harga Add-on</h2>
          </div>
          <p className="mt-1 text-xs text-slate-500">
        ...
        <div className="p-6">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {addons.map((addon) => (
              <div key={addon.id} className="flex flex-col gap-2 p-4 rounded-2xl border border-slate-100 bg-slate-50/50">
                <div className="flex items-start gap-3">
                  <div className="flex-1">
          ...
          <div className="mt-8 flex items-center justify-end gap-4 border-t border-slate-100 pt-6">
            ...
            <button
              onClick={handleSave}
              disabled={isPending}
              className="inline-flex items-center gap-2 rounded-2xl bg-blue-600 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-blue-100 hover:bg-blue-700 transition-all disabled:opacity-50"
            >
              {isPending ? (
