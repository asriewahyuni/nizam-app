    ...
    <div className="space-y-6 pb-16">
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1 text-[11px] font-black tracking-[0.12em] text-indigo-700">
              <LifeBuoy size={14} />
              ...
              <article key={ticket.id} className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-2 text-[11px] font-black uppercase tracking-[0.14em] text-slate-700 hover:bg-slate-100"
                  >
                ...
                {isProgressCardOpen ? (
                  ...
                  <div className="mt-4 rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-4 py-4 text-sm font-semibold text-slate-500">
                    Panel update sedang ditutup agar daftar ticket lebih rapi. Klik <span className="font-black text-slate-700">Buka Panel Update</span> untuk kirim progres baru.
                  </div>
                )}
              </article>
            )
