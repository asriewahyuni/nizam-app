    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 px-1">
        <div className="space-y-2">
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3 py-1.5 text-[10px] font-semibold tracking-tight text-blue-700">
                ...
                <div key={b.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-2xl border border-slate-100 hover:border-blue-100 bg-slate-50 hover:bg-blue-50/30 transition-colors group">
                  <div className="flex gap-4 items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-bold text-slate-500 mt-1 tracking-tight">{b.learning_courses?.title || 'Program'}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-6 text-sm">
                    <div className="text-right">
                      <div className="text-[10px] font-semibold tracking-tight text-slate-400">Harga</div>
                      <div className="font-bold text-slate-700 mt-0.5">{b.price === 0 ? 'GRATIS' : formatRupiah(b.price)}</div>
                    </div>
                    <div className="text-right">
                      <div className="text-[10px] font-semibold tracking-tight text-slate-400">Kuota</div>
