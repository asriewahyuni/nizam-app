      ...
      <div className="max-w-4xl w-full px-6 relative z-10 flex flex-col items-center">
           ...
           <div className="bg-white rounded-[40px] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)] border-t-[12px] border-[#004AB8] relative overflow-hidden flex flex-col items-stretch">
              ...
              <div className="p-10 text-center border-b-2 border-dashed border-slate-100 relative">
                 ...
                 <h1 className="text-4xl md:text-5xl font-black text-[#004AB8] tracking-tighter uppercase italic leading-none mb-4">
                    Digital Membership <br className="hidden md:block" />
                    <span className="text-orange-500 not-italic">ACCELERATION TICKET</span>
                 </h1>
              ...
              <div className="p-10 flex flex-col md:flex-row items-center justify-between gap-10 bg-[#FBFCFE]">
                 <div className="space-y-6 flex-1">
                    <div className="space-y-1">
                       <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-2">Benefit Reward:</p>
                       <div className="flex items-baseline gap-2">
                          <span className="text-6xl font-black text-[#004AB8] italic tracking-tighter">FREE</span>
                          <span className="text-3xl font-black text-[#004AB8]/40 uppercase">1 YEAR</span>
                       </div>
                    </div>
                    
                    <div className="space-y-4 pt-4">
                       <BenefitLine text="Full Professional Modules access" />
                       <BenefitLine text="Syariah-compliant Accounting engine" />
                       <BenefitLine text="Real-time multi-platform dashboard" />
                    </div>
                 </div>
        ...
        <div className="mt-20">
           <Link href="/pricing" className="text-[10px] font-black text-slate-300 hover:text-blue-500 transition-colors uppercase tracking-[0.3em] flex items-center gap-2">
              <Building2 size={12} /> View Standard Packages
           </Link>
        </div>
      </div>
...
function BenefitLine({ text }: { text: string }) {
  return (
    <div className="flex items-center gap-3 group">
       <div className="w-5 h-5 bg-blue-100 rounded-full flex items-center justify-center shrink-0 group-hover:bg-[#004AB8] transition-colors duration-500">
          <CheckCircle2 size={12} className="text-[#004AB8] group-hover:text-white transition-colors" />
       </div>
       <span className="text-[11px] font-black text-slate-500 group-hover:text-[#004AB8] transition-colors uppercase italic tracking-tighter">{text}</span>
    </div>
  )
}
