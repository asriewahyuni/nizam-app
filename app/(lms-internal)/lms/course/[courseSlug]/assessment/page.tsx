...
export default async function LearningCourseAssessmentPage(props: {
  ...
  if (!canManageAssessment) {
    return redirect(`/lms/course/${course.slug}/assessment/participant`)
  }
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-5 grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Metode Penilaian</div>
      ...
      {canManageAssessment ? (
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Peserta Terpantau</div>
            <div className="mt-3 text-3xl font-semibold tracking-tight text-slate-900">{participantStatuses.length}</div>
          ...
          <div className="rounded-[24px] border border-emerald-200 bg-emerald-50 p-5 shadow-sm">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-emerald-700">Kompeten</div>
            <div className="mt-3 text-3xl font-semibold tracking-tight text-emerald-900">{competentParticipantCount}</div>
          ...
          <div className="rounded-[24px] border border-amber-200 bg-amber-50 p-5 shadow-sm">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-amber-700">Belum Kompeten</div>
            <div className="mt-3 text-3xl font-semibold tracking-tight text-amber-900">{notYetParticipantCount}</div>
            <p className="mt-2 text-sm text-amber-800">Peserta yang masih perlu remedial atau review ulang.</p>
          </div>
          <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Total Submission</div>
            <div className="mt-3 text-3xl font-semibold tracking-tight text-slate-900">{submissions.length}</div>
      ...
      <section className="grid gap-6 xl:grid-cols-2">
        <div className="rounded-xl border border-emerald-200 bg-emerald-50/60 p-6 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-wide text-emerald-700">Keputusan</div>
              <h2 className="mt-1 text-xl font-semibold text-slate-900">Kompeten jika</h2>
            </div>
          </div>
          <div className="mt-5 space-y-3 text-sm text-slate-700">
            {assessment.competentWhen.map((item) => (
              <div key={item} className="rounded-xl border border-emerald-200 bg-white/90 p-4">
                {item}
              </div>
            ))}
          </div>
        ...
        <div className="rounded-xl border border-amber-200 bg-amber-50/70 p-6 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-wide text-amber-700">Remedial</div>
              <h2 className="mt-1 text-xl font-semibold text-slate-900">Belum kompeten jika</h2>
            </div>
          </div>
          <div className="mt-5 space-y-3 text-sm text-slate-700">
            {assessment.notYetCompetentWhen.map((item) => (
              <div key={item} className="rounded-xl border border-amber-200 bg-white/90 p-4">
                {item}
              </div>
            ))}
          </div>
      ...
      <section className="grid gap-6 xl:grid-cols-[1fr_1fr]">
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Teori</div>
              <h2 className="mt-1 text-xl font-semibold text-slate-900">Pertanyaan acuan penilai</h2>
            </div>
          </div>
          <div className="mt-5 space-y-3 text-sm text-slate-600">
            {assessment.theoryQuestions.map((question, index) => (
              <div key={question} className="flex items-start gap-3 rounded-xl border border-slate-200 bg-slate-50 p-4">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-white text-sm font-semibold text-slate-900 shadow-sm">
                  {index + 1}
                </div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Kunci Acuan</div>
              <h2 className="mt-1 text-xl font-semibold text-slate-900">Panduan jawaban singkat</h2>
            </div>
          </div>
          <div className="mt-5 space-y-3 text-sm text-slate-600">
            {assessment.answerGuide.map((answer, index) => (
              <div key={answer} className="flex items-start gap-3 rounded-xl border border-slate-200 bg-slate-50 p-4">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-white text-sm font-semibold text-slate-900 shadow-sm">
                  {index + 1}
                </div>
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        <div>
          <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Praktik</div>
          <h2 className="mt-2 text-xl font-semibold text-slate-900">Tugas unjuk kerja</h2>
        </div>
      ...
      <section className="grid gap-6 xl:grid-cols-[1fr_1fr]">
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div>
            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Checklist</div>
            <h2 className="mt-2 text-xl font-semibold text-slate-900">Daftar cek unjuk kerja</h2>
          </div>
          <div className="mt-5 space-y-3 text-sm text-slate-600">
        ...
        <div className="space-y-6">
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Bukti</div>
              <h2 className="mt-2 text-xl font-semibold text-slate-900">Bukti yang dikumpulkan penilai</h2>
            </div>
            <div className="mt-5 space-y-3 text-sm text-slate-600">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Tindak Lanjut</div>
              <h2 className="mt-2 text-xl font-semibold text-slate-900">Panduan remedial dan kelulusan</h2>
            </div>
            <div className="mt-5 space-y-3 text-sm text-slate-600">
      ...
      {canManageAssessment ? (
        <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex items-center justify-between gap-4">
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Status Peserta</div>
              <h2 className="mt-2 text-xl font-semibold text-slate-900">Kelulusan terbaru per trainee</h2>
            </div>
          ...
          <div className="mt-5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <form method="get" className="flex w-full max-w-2xl flex-col gap-3 sm:flex-row">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-900 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-200 transition hover:bg-black"
              >
                Filter
              </button>
              {participantFilter ? (
                <Link
                  href={`/lms/course/${course.slug}/assessment#submissions`}
                  className="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-slate-300 hover:text-slate-900"
                >
                  Reset
                </Link>
              ) : null}
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
              <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Jawaban Masuk</div>
              <div className="mt-2 text-2xl font-semibold text-slate-900">{participantAnswerSubmissions.length}</div>
            </div>
            <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
              <div className="text-[11px] font-semibold uppercase tracking-wide text-amber-700">Menunggu Review</div>
              <div className="mt-2 text-2xl font-semibold text-amber-900">{pendingAnswerReviewCount}</div>
            </div>
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4">
              <div className="text-[11px] font-semibold uppercase tracking-wide text-emerald-700">Sudah Direview</div>
              <div className="mt-2 text-2xl font-semibold text-emerald-900">{reviewedAnswerCount}</div>
            </div>
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
              <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Submission Dipilih</div>
                ...
                <div key={item.participantKey} className="rounded-[24px] border border-slate-200 bg-slate-50 p-5">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h3 className="mt-3 text-lg font-semibold text-slate-900">{item.participantName}</h3>
                    ...
                    <div className="rounded-[20px] border border-slate-200 bg-white px-4 py-3 text-right">
                      <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Update</div>
                      <div className="mt-2 text-sm font-semibold text-slate-900">{formatAssessmentDate(item.latestAssessedAt)}</div>
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    <div className="rounded-[18px] border border-slate-200 bg-white p-4">
                      <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Status Teori</div>
                      <div className="mt-2 text-sm font-semibold text-slate-900">
                    ...
                    <div className="rounded-[18px] border border-slate-200 bg-white p-4">
                      <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Status Praktik</div>
                      <div className="mt-2 text-sm font-semibold text-slate-900">
      ...
      {canManageAssessment ? (
        <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex items-center justify-between gap-4">
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Review Jawaban</div>
              <h2 className="mt-2 text-xl font-semibold text-slate-900">Jawaban peserta yang masuk</h2>
              <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
                Pilih submission peserta untuk ditarik ke form asesmen penilai. Saat asesmen final disimpan, submission ini otomatis ditandai sudah direview.
              </p>
            </div>
            <div className="rounded-full bg-slate-100 px-3 py-2 text-xs font-semibold uppercase tracking-wide text-slate-600">
              Review queue
          ...
          {participantAnswerSubmissions.length === 0 ? (
            ...
            <div className="mt-5 space-y-4">
              {participantAnswerSubmissions.map((submission) => {
                ...
                const submissionHref = `/lms/course/${course.slug}/assessment?${submissionLinkParams.toString()}#assessor-form`
                  ...
                  >
                    <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                      <div>
                        ...
                        <h3 className="mt-3 text-lg font-semibold text-slate-900">{submission.participantName}</h3>
                        <div className="mt-2 text-sm text-slate-600">
                          {submission.participantRole || 'Peran belum diisi'}
                          {submission.participantReference ? ` • ${submission.participantReference}` : ''}
                        </div>
                        <div className="mt-3 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-slate-500">
                      ...
                      <div className="space-y-3">
                        {submission.theoryAnswers.map((item, index) => (
                          <div key={`${submission.id}-theory-${index}`} className="rounded-[20px] border border-slate-200 bg-white p-4 text-sm text-slate-600">
                            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Teori {index + 1}</div>
                      ...
                      <div className="space-y-3">
                        {submission.practicalAnswers.map((item, index) => (
                          <div key={`${submission.id}-practice-${index}`} className="rounded-[20px] border border-slate-200 bg-white p-4 text-sm text-slate-600">
                            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Praktik {index + 1}</div>
                            <div className="mt-2 font-bold text-slate-900">{item.prompt}</div>
                            <p className="mt-2 leading-6">{item.answer || '-'}</p>
                          </div>
                        ))}
                        ...
                        {submission.generalNotes ? (
                          <div className="rounded-[20px] border border-slate-200 bg-white p-4 text-sm text-slate-600">
                            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Catatan Peserta</div>
                        ...
                        {submission.reviewerNote ? (
                          <div className="rounded-[20px] border border-slate-200 bg-white p-4 text-sm text-slate-600">
                            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Catatan Reviewer</div>
      ...
      <section id="assessor-form" className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex items-center justify-between gap-4">
          <div>
            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Form Online</div>
            <h2 className="mt-2 text-xl font-semibold text-slate-900">Input hasil asesmen penilai</h2>
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
        ...
        {canManageAssessment ? (
          <form action={submitTrainingCourseAssessment} className="mt-6 space-y-6">
            ...
            {selectedAnswerSubmission ? (
              <div className="rounded-[24px] border border-emerald-200 bg-emerald-50 p-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[11px] font-semibold uppercase tracking-wide text-emerald-700">Submission Dipakai</div>
                    <h3 className="mt-1 text-lg font-semibold text-slate-900">{selectedAnswerSubmission.participantName}</h3>
                  </div>
                </div>
                <p className="mt-3 text-sm leading-6 text-slate-700">
                  Form penilai sekarang diprefill dari submission peserta ini. Saat asesmen final disimpan, submission akan otomatis ditandai sudah direview.
                </p>
              </div>
            ) : null}
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <label className="space-y-2">
                <span className="text-xs font-semibold uppercase tracking-wide text-slate-500">Keputusan Akhir</span>
                <select
                  name="decision"
              ...
              <label className="space-y-2">
                <span className="text-xs font-semibold uppercase tracking-wide text-slate-500">Status Teori</span>
                <select
                  name="theoryStatus"
              ...
              <label className="space-y-2">
                <span className="text-xs font-semibold uppercase tracking-wide text-slate-500">Status Praktik</span>
                <select
                  name="practiceStatus"
            ...
            <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-5">
              <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Checklist Unjuk Kerja</div>
              <div className="mt-4 grid gap-4 xl:grid-cols-2">
                {assessment.performanceChecklist.map((item, index) => (
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <label className="space-y-2">
                <span className="text-xs font-semibold uppercase tracking-wide text-slate-500">Bukti Yang Diamati</span>
                <textarea
              ...
              <label className="space-y-2">
                <span className="text-xs font-semibold uppercase tracking-wide text-slate-500">Kekuatan Peserta</span>
                <textarea
                  name="strengths"
                  rows={5}
              ...
              <label className="space-y-2">
                <span className="text-xs font-semibold uppercase tracking-wide text-slate-500">Kesalahan Berulang</span>
                <textarea
                  name="repeatedErrors"
                  rows={5}
              ...
              <label className="space-y-2">
                <span className="text-xs font-semibold uppercase tracking-wide text-slate-500">Tindak Lanjut</span>
                <textarea
                  name="followUp"
                  rows={5}
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <div className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold text-slate-600">
                Penilai aktif: {activeReviewerLabel}
              </div>
            </div>
          </form>
        ) : (
          <div className="mt-6 rounded-[24px] border border-dashed border-slate-300 bg-slate-50 p-5 text-sm font-bold text-slate-600">
            Pengelola kompetensi internal dengan akses `learning:write` atau assessor SaaS dapat mengirim asesmen online. Peserta tenant tetap bisa membaca rubrik dan kriteria penilaian di halaman ini.
          </div>
        )}
      </section>
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-xl font-semibold text-slate-900">Gunakan lembar ini saat review trainer</h2>
          </div>
          <div className="flex flex-wrap gap-3">
            <Link
              href={`/lms/course/${course.slug}`}
            ...
            <Link
              href={firstLesson ? `/lms/course/${course.slug}/lesson/${firstLesson.slug}` : `/lms/course/${course.slug}`}
      ...
      {canManageAssessment ? (
        <section id="submissions" className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex items-center justify-between gap-4">
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Riwayat Online</div>
              <h2 className="mt-2 text-xl font-semibold text-slate-900">Submission asesmen terbaru</h2>
            </div>
            <div className="rounded-full bg-slate-100 px-3 py-2 text-xs font-semibold uppercase tracking-wide text-slate-600">
                  ...
                  <div key={submission.id} className="rounded-[24px] border border-slate-200 bg-slate-50 p-5">
                    <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                      <div>
                        ...
                        <div className="mt-3 flex flex-wrap gap-3 text-xs font-bold uppercase tracking-wide text-slate-500">
                          <span>Penilai: {submission.assessorName}</span>
                    ...
                    <div className="mt-4 grid gap-4 xl:grid-cols-2">
                      <div className="space-y-3 text-sm text-slate-600">
                        ...
                        {submission.strengths ? (
                          <div className="rounded-[20px] border border-slate-200 bg-white p-4">
                            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Kekuatan</div>
                      ...
                      <div className="space-y-3 text-sm text-slate-600">
                        {submission.repeatedErrors ? (
                          <div className="rounded-[20px] border border-slate-200 bg-white p-4">
                            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Kesalahan Berulang</div>
