          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
            ...
            <div className="mt-4 space-y-3 text-sm text-slate-600">
              <div className="rounded-[20px] border border-slate-200 bg-white p-4">
                <div className="font-semibold text-slate-900">Entitas</div>
                <div className="mt-1">{orgData.org.name}</div>
              </div>
              <div className="rounded-[20px] border border-slate-200 bg-white p-4">
                <div className="font-semibold text-slate-900">Mode Penilai</div>
                <div className="mt-1">
              ...
              {dashboard.activeUnit ? (
                <div className="rounded-[20px] border border-slate-200 bg-white p-4">
                  <div className="font-semibold text-slate-900">Unit Aktif</div>
        ...
        {dashboard.courseSummaries.map((course) => (
          <div key={course.courseSlug} className="rounded-[26px] border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="text-[11px] font-semibold uppercase tracking-wide text-emerald-700">{course.levelCode}</div>
              ...
              <div className="rounded-full bg-slate-100 px-3 py-1 text-[10px] font-semibold uppercase tracking-wide text-slate-600">
                {course.status}
              </div>
            </div>
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              <div className="rounded-[18px] border border-slate-200 bg-slate-50 p-4">
                ...
                <div className="mt-2 text-[11px] font-semibold uppercase tracking-wide text-slate-500">Pending</div>
                <div className="mt-2 text-2xl font-semibold text-slate-900">{course.pendingAnswerCount}</div>
              </div>
              <div className="rounded-[18px] border border-slate-200 bg-slate-50 p-4">
                <ClipboardCheck className="h-4 w-4 text-slate-500" />
                <div className="mt-2 text-[11px] font-semibold uppercase tracking-wide text-slate-500">Direview</div>
                <div className="mt-2 text-2xl font-semibold text-slate-900">{course.reviewedAnswerCount}</div>
              </div>
              <div className="rounded-[18px] border border-slate-200 bg-slate-50 p-4">
                <FileText className="h-4 w-4 text-slate-500" />
                <div className="mt-2 text-[11px] font-semibold uppercase tracking-wide text-slate-500">Final</div>
                <div className="mt-2 text-2xl font-semibold text-slate-900">{course.finalAssessmentCount}</div>
              </div>
              <div className="rounded-[18px] border border-slate-200 bg-slate-50 p-4">
                <ShieldCheck className="h-4 w-4 text-slate-500" />
                <div className="mt-2 text-[11px] font-semibold uppercase tracking-wide text-slate-500">Kompeten</div>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white transition hover:bg-black"
              >
                Buka Review Penilai
