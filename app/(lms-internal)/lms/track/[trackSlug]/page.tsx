      ...
      <section className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-5 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-5 text-sm text-slate-600">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-slate-500">Audience</div>
            <div className="mt-2 font-bold text-slate-900">{track.audience}</div>
            <div className="mt-4 text-[11px] font-semibold uppercase tracking-wide text-slate-500">Course</div>
        ...
        {courses.map((course) => (
          <div key={course.slug} className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="inline-flex rounded-full bg-slate-100 px-3 py-1 text-[10px] font-semibold uppercase tracking-wide text-slate-600">
                  {course.levelCode}
                </div>
