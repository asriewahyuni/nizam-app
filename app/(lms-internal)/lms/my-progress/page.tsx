    ...
    <div className="space-y-6">
      ...
      <section className="overflow-hidden rounded-[32px] border border-violet-200 bg-[radial-gradient(circle_at_top_left,_rgba(139,92,246,0.12),_transparent_40%),linear-gradient(135deg,#f5f3ff_0%,#ffffff_50%,#eff6ff_100%)] p-6 shadow-sm">
        ...
        <div className="mt-5 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-violet-200 bg-white/85 px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-violet-700">
          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <Link
                ...
                className="inline-flex shrink-0 items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-700 transition hover:border-slate-300"
              >
                Lihat Track
                  ...
                  >
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                      <div className="flex items-start gap-4">
                        <div
                          className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl text-sm font-semibold shadow-sm ${
                        ...
                        {isLive ? (
                          <>
                            <Link
                              ...
                              className="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-emerald-100 transition hover:bg-emerald-700"
                            >
                              Mulai Belajar
                              <ArrowRight className="h-4 w-4" />
                            </Link>
                          ...
                          <div className="rounded-xl border border-dashed border-slate-300 bg-white px-4 py-2.5 text-sm font-bold text-slate-400">
                            Segera Hadir
                          </div>
                        )}
                      </div>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <h3 className="mt-4 text-base font-semibold text-slate-900">Belajar Mandiri</h3>
        ...
        <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <h3 className="mt-4 text-base font-semibold text-slate-900">Assessment Peserta</h3>
          <p className="mt-2 text-sm leading-6 text-slate-600">
        ...
        <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <h3 className="mt-4 text-base font-semibold text-slate-900">Status Kelulusan</h3>
          <p className="mt-2 text-sm leading-6 text-slate-600">
