...
const nav = [
  ...
  { to: '/lms/admin', label: 'Katalog Course', icon: BookOpen },
  { to: '/lms/admin/penjualan', label: 'Penjualan Kelas', icon: ShoppingCart },
  { to: '/lms/admin/settings', label: 'Pengaturan', icon: Settings },
]
...
function isNavItemActive(pathname: string, target: string) {
  ...
  if (target === '/lms/admin') {
    return pathname.startsWith('/lms/admin')
