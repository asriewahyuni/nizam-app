...
description: "Dokumen ini membantu developer menjalankan project, memahami kebiasaan kerja repo, dan tahu harus mulai dari mana saat mengerjakan fitur atau bugfix."
sidebar:
  label: "Panduan Developer"
---

> Dokumen ini disinkronkan otomatis dari file sumber `developer-guide.md` di root project docs.
