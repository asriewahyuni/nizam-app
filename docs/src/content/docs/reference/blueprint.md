---
title: "Blueprint:"
description: "> Dokumen ini menjelaskan arsitektur, definisi core, dan filosofi desain sistem Nizam ERP."
sidebar:
  label: "Blueprint:"
---

> Dokumen ini disinkronkan otomatis dari file sumber `BLUEPRINT.md` di root project docs.
