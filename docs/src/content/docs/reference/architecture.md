...
description: "Dokumen ini merangkum arsitektur teknis NIZAM dari sisi route, auth, tenancy, akses data, dan boundary antar layer."
sidebar:
  label: "Arsitektur Sistem"
---

> Dokumen ini disinkronkan otomatis dari file sumber `architecture.md` di root project docs.
