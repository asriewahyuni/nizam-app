...
description: "Folder `docs/` adalah pusat dokumentasi teknis yang lebih ringkas, terstruktur, dan mudah dibaca dibanding dokumen audit panjang. Gunakan folder ini sebagai jal"
sidebar:
  label: "Ringkasan Dokumentasi"
---

> Dokumen ini disinkronkan otomatis dari file sumber `README.md` di root project docs.
