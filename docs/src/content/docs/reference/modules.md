---
title: "Peta Modul dan Route"
description: "Dokumen ini membantu developer menemukan domain bisnis, route utama, dan lokasi kode yang biasanya perlu disentuh saat mengerjakan fitur tertentu."
sidebar:
  label: "Peta Modul dan Route"
---

> Dokumen ini disinkronkan otomatis dari file sumber `modules.md` di root project docs.
