...
Dokumentasi ini telah diaudit ulang berdasarkan kode aktual pada **7 April 2026**.
...
- `127` file migrasi SQL historis di `supabase/migrations/`
- `7` file test Vitest
...
- auth, organisasi, RBAC, branch access, dan module gating
- peta route yang aktif saat ini
- ringkasan lengkap modul bisnis dan server actions
- peta arsitektur data Prisma/PostgreSQL dan storage lokal publik
...
- Runtime app sekarang **sudah tidak memakai Supabase client lagi**; akses data berjalan melalui **Prisma + PostgreSQL** dan auth melalui **NextAuth**.
