...
export function CurrencyInput({ 
  ...
  return (
    <div className="space-y-1.5 flex-1">
      <label className={`text-[10px] font-semibold uppercase tracking-wide px-1 ${labelClassName || 'text-slate-400'}`}>
        {label}
      </label>
      <div className="relative">
        ...
        <input
          ...
          autoComplete="off"
          disabled={disabled}
          className={`w-full px-5 py-3 border rounded-xl outline-none text-sm font-semibold transition-all ${
            highlight 
