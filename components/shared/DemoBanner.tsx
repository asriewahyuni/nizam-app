    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 px-3 py-1 bg-amber-500/10 border border-amber-500/30 rounded-full">
          ...
          <span className="text-[10px] font-semibold text-amber-500 uppercase tracking-wide leading-none">
            MODE DEMO AKTIF
          </span>
        </div>
      ...
      <form action={signOutDemo}>
        <button
          type="submit"
          className="flex items-center gap-2 px-4 py-1.5 bg-white/5 hover:bg-rose-500/20 hover:text-rose-400 backdrop-blur-sm text-white/60 text-[10px] font-semibold uppercase tracking-wide rounded-lg transition-all border border-white/10 hover:border-rose-500/30 active:scale-95 group"
        >
