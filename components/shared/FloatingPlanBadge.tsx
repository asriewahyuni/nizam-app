...
export function FloatingPlanBadge({ planName = 'Trial' }: FloatingPlanBadgeProps) {
  return (
    ...
    >
      <Link
        href="/billing"
        className="group flex items-center gap-3 pl-4 pr-5 py-2.5 rounded-full bg-slate-900/90 backdrop-blur-md text-white shadow-2xl shadow-indigo-900/40 hover:shadow-indigo-500/30 hover:-translate-y-1 transition-all duration-300 border border-white/10"
      >
        ...
        <div className="flex flex-col">
          <span className="text-[8px] font-black text-white/50 uppercase tracking-[0.2em] leading-none mb-0.5">PAKET AKTIF</span>
          <span className="text-[11px] font-black text-white group-hover:text-indigo-300 transition-colors uppercase tracking-widest leading-none flex items-center gap-1.5">
            {planName} 
