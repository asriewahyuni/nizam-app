...
const MIGRATION_FILE = 'supabase/migrations/1235_training_course_assessments.sql'
...
async function run() {
  ...
  const verification = await client.query(`
    ...
    WHERE table_schema = 'public'
      AND table_name = 'training_course_assessments'
  ...
  console.log('✅ Verifikasi tabel training_course_assessments berhasil.')
}
